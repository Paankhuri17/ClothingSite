...
<head>
    ...
    <style>
    	body {
			...
			.hero {
			    height: 60vh;
			    background: url('Images/women_main.jpg') no-repeat center center;
    ...
    <div class="men-page">
        <header class="header">
            ...
            <div class="title-section">
                <h1>Woman</h1>
                <p class="subtext">Explore our new arrivals in woman's fashion</p>
            </div>
        </header>
            ...
            <div class="arrivals-grid">
            	<%
		            ...
		            try {
		                ...
		                rs = stmt.executeQuery("Select * from products where category='women' and new_arrival='y';");
        ...
        <section class="clothing-grid">
            ...
            <div class="grid">
            <%
    		  rs = stmt.executeQuery("Select * from products where category='women' and new_arrival='n' and accessory='n';");
              while (rs.next()) {
                  String image = rs.getString("image_url");
                  String name = rs.getString("name");
                  String sale= rs.getString("sale");
